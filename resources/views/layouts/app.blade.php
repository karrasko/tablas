            ...
            <div class="container">
                    ...
                    <ul class="navbar-nav mr-auto">
                     ...
                     @if (auth()->check())
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" href="{{ route('saludo s','Jorge') }}">{{ __('Inicio') }}</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('fichajestareas.index') }}">{{ __('fichajestareas') }}</a>
                            
                            {{-- <a class="nav-link" href="{{ route('home.index') }}">{{ __('Inicio') }}</a>
                            <a class="nav-link" href="{{ route('saludos','Jorge') }}">{{ __('Inicio') }}</a>
                            <a class="nav-link" href="{{ route('contactos') }}">{{ __('Contacto') }}</a> --}}
                           
                        </li> 
                            
                            @if (auth()->user()->hasRoles (['admin','otro']))
                ...
                {{--   
                  //  buscador
                    ...
                    <form class="navbar-form navbar-left" role="search" action=""></form>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                                <li>
                                <a href="{{ route('createVideo')  }}#">Proyecto</a>
                                </li>
